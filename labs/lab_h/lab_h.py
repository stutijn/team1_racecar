...
def update_contour():
    ...
    if image is None:
        ...
        print(f"Blue area: {contour_b_area}, Red contour: {contour_r_area}")
...
def update():
    ...
    # right = rc_utils.get_lidar_average_distance(scan, 30, 20)
    # left = rc_utils.get_lidar_average_distance(scan, 330, 20)
    right = rc_utils.get_lidar_average_distance(scan, 30, 10)
    ...
    # set states
    if contour_r_area > contour_b_area and contour_r_area < MAX_CONTOUR_AREA:
        current_state = "RIGHT"
        last_state = "RIGHT"
    elif contour_r_area < contour_b_area and contour_b_area < MAX_CONTOUR_AREA:
        current_state = "LEFT"
        last_state = "LEFT"
