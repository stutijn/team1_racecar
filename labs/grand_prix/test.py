...
# STATES = {1: "LEFT", 2: "RIGHT", 3: "MIDDLE", 4: "TURN LEFT", 5: "TURN RIGHT"}
...
def update():
    ...
    angle_l, distance_l = rc_utils.get_lidar_closest_point(scan, (180, 0))
    print(f"Distance: {distance_l}; Angle: {angle_l}")
